...
VALUES
  (0, 'r_Local_2_I_Ch0Data', 'PCV-01 Valvula de Gas',        1000.0,  4.0,  20.0, 1, 0),
  (1, 'r_Local_2_I_Ch1Data', 'LIC-01 Valvula de Liquido',    1000.0,  4.0,  20.0, 1, 1),
  (2, 'r_Local_2_I_Ch2Data', 'VIT-01 VIscosimetro',          1000.0,  4.0,  20.0, 1, 2),
  (3, 'r_Local_2_I_Ch3Data', 'GVF Sonartrac/Sensor',         1000.0,  4.0,  20.0, 1, 3),
